...
- Snyks - [Snyks](https://snyk.io/test/github/dugudugu/SIRA?targetFile=requirements.txt) is used to check if there are any vulnerability in your requirements files
