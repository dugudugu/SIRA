Travis CI [![Build Status](https://travis-ci.org/dugudugu/SIRA.svg?branch=master)](https://travis-ci.org/dugudugu/SIRA) 
Snyk [![Known Vulnerabilities](https://snyk.io/test/github/dugudugu/SIRA/badge.svg?targetFile=requirements.txt)](https://snyk.io/test/github/dugudugu/SIRA?targetFile=requirements.txt)
<div align="center">
...
- Snyks - [Snyks](https://snyk.io/) is used to check if there are any vulnerability in your requirements files
